...
- **Still open in M2:** 2.6 (IPAM), 2.7 (cross-account KMS isolation), 2.8 (`harbor issue-cert` CLI tying 2.3–2.6 together) and 2.9–2.13 (observability, secrets, dual-control/RBAC, device-state, WORM export). KMS `Backend` lands with 2.7.
